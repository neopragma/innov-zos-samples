      ...
      *        LIBRARY(MATEDG.DCLGEN.COBOL(CONTACTS))                  *
      *        LANGUAGE(COBOL)                                         *
      *        QUOTE                                                   *
      ...
      ******************************************************************
       01  DCLCONTACTS.
           10 CONTACTS-ID          PIC S9(9) USAGE COMP.
           10 LANG                 PIC X(2).
           10 SURNAME.
